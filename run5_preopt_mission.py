...
i_twist = 0.0*numpy.array([  5.551818  ,   7.79683603,   8.08644911,   8.75282246,
        10.        ,  10.        ])
i_shape = 0.0*numpy.array([ -4.02541894e-02,   4.02541894e-02,  -1.43523261e-01,
         1.43523261e-01,   1.75834442e-03,  -1.75834442e-03,
        -2.36075536e-02,   2.36075536e-02,   4.55715459e-03,
         4.24397956e-02,  -3.46306415e-02,  -9.81809051e-02,
         5.55118306e-02,   2.02337937e-02,  -1.73026333e-02,
         2.29473599e-02,  -1.89000125e-03,   1.85142621e-02,
        -9.30890413e-03,  -5.35201226e-02,   5.57360402e-03,
         9.16006126e-03,   1.06740827e-02,   2.11684265e-02,
        -2.60743193e-02,   2.84143868e-03,  -1.07133098e-04,
         2.64152380e-03,  -1.87375443e-01,  -1.98543825e-01,
        -1.49196439e-01,  -1.56491652e-01,   2.60743193e-02,
        -2.84143868e-03,   1.07133098e-04,  -2.64152380e-03,
         1.87375443e-01,   1.98543825e-01,   1.49196439e-01,
         1.56491652e-01,  -4.44935730e-03,   1.06083604e-02,
         4.95382805e-03,   1.02729007e-02,   2.46038842e-02,
         2.84560830e-02,   2.62093461e-02,   2.80412925e-02,
        -3.00453862e-02,  -2.77426431e-02,  -1.12419906e-02,
         3.67969141e-04,  -1.41934651e-01,  -8.67687552e-02,
        -8.89513548e-02,  -3.37657664e-02,   1.11758126e-02,
         2.05262163e-02,   1.37861364e-02,   2.63854173e-02,
         7.14723854e-03,   1.38859864e-02,   1.52666583e-02,
         1.42975375e-02,   1.52703553e-03,   1.39233107e-02,
         1.59697863e-02,   1.88751861e-02,   6.97506559e-02,
         6.86396953e-02,   6.18172935e-02,   5.54184185e-02])
...
top = Assembly('sys_top', subsystems=[
    IndVar('twist', value=i_twist.copy()),
    IndVar('shape', value=i_shape.copy()),
...
for irun in range(raw.shape[0]):
    ...
    if numpy.all(ac_con < avail):
        ...
        # Reset internal states so we start with a clean slate.
        top.util_initial_values()
        ...
        alloc['pax_flt'].value = pax_flt_init.astype(float)
        top['shape'].value = i_shape.copy()
        top['twist'].value = i_twist.copy()
        for j in range(8):
            root = 'sys_msn%d.' % j
